#!/usr/bin/env python3
"""
verify.py - Playwright wrapper for validating Slide ProMax HTML outputs.
...
Usage:
    ...
    python verify.py deck.html --slides 10                  # Slide mode: capture first 10 slides.
...
def main():
    ...
    parser.add_argument("--output", default=None,
                        help="Output directory (default: screenshots/ beside the HTML file)")
