#!/usr/bin/env node
/**
 * export_deck_pdf.mjs - export a multi-file slide deck into one vector PDF.
 *
 * Usage:
 ...
 *   - Backgrounds and graphics preserve 1:1 fidelity through Playwright Chromium rendering.
 *   - No HTML restructuring is required.
 *   - Visual loss is zero because the PDF is produced by browser print output.
 *
 * trade-off：
 *   - PDF text is not editable afterward; edit the source HTML instead.
 *
