 ...
 *
 * Features:
 * - Fixed-size canvas (default 1920x1080) with auto-scale and letterboxing.
 ...
 * - Speaker notes postMessage support for outer renderers.
...
(function() {
  ...
  class DeckStage extends HTMLElement {
    ...
    connectedCallback() {
      ...
      // Render Shadow DOM first, independent of child parsing timing.
      this._render();

      // Defensive path: if the script is in <head> instead of after </deck-stage>,
      ...
      if (this.ownerDocument.readyState === 'loading') {
        // The document is still parsing; collect sections after DOMContentLoaded.
