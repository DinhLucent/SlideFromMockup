 ...
 *
 * Lightweight Stage + Sprite model inspired by Remotion.
 *
 * Exports through window.Animations:
...
(function() {
  ...
  const Easing = {
    ...
    // Fast launch and slow braking, giving digital elements physical weight.
