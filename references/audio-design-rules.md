# Audio Design Rules · Slide ProMax

 > Sound application blueprints for all animation demos. Use strictly in tandem with `sfx-library.md` (Asset manifest).
 > Refined through combat: Slide ProMax release hero iterations v1-v9 · Anthropic 3 official ad deep teardowns · 8000+ A/B comparisons
 ...
 **P2 Optional** (Use sparingly, creates noise if overused):
 ...
 Slide ProMax inherently provides 6 built-in BGMs (`assets/bgm-*.mp3`):
 ...
 **When to use Zero BGM**:
 ...
 ### Blueprint A · Product Launch Hero (Matching Slide ProMax v9)
 ```
 Duration: 25 Seconds
 ...
 **Key Params**:
 ...
 | Social media video has no sound | Apps occasionally mute auto-plays natively | Ignore. Tapping the video enables sound normally. |
